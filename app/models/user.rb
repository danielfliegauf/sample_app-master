class User < ActiveRecord::Base
  ...
  has_many :user_visits_reverse, foreign_key: "visitor_id", class_name: "UserVisit", dependent: :destroy
  has_many :visited_users, through: :user_visits_reverse, source: :user
  # has_secure_password
